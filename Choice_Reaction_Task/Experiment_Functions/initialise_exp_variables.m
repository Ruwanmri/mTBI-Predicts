...
cfgExp.numTrial = 15;  % number of trials in each block 
cfgExp.numruns= 2; % number of runs (ruwan)
cfgExp.numStim = cfgExp.numTrial * cfgExp.numBlock * cfgExp.numruns;  % number of stimuli in total
...
if strcmp(cfgExp.answer.pc,'MRI'), cfgExp.MEGLab = 1; else, cfgExp.MEGLab = 0; end  % MRI lab computer-> 1 PC-> 0 (Ruwan testing)
