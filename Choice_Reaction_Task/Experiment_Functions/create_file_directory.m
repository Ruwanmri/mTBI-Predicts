...
mkdir([cfgFile.res, 'sub-', cfgExp.answer.sub, filesep, 'ses-', cfgExp.answer.ses, filesep, 'mri', filesep]);  % make result directory with BIDS format (ruwan testing)
cfgFile.subDir = [cfgFile.res, 'sub-', cfgExp.answer.sub, filesep, 'ses-' cfgExp.answer.ses, filesep, 'mri', filesep];  % store subject directory address (ruwan testing)
